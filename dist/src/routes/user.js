...
userRouter.post('/register', (0, inputValidation_1.usernameValidator)("username"), (0, inputValidation_1.emailValidator)("email"), (0, inputValidation_1.passValidator)("password"), async (req, res) => {
